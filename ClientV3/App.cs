namespace ClientV3
{
    ...
    class App
    {
        ...
        /// </summary>
        static string outputFileNameOSS = string.Format("{0}_input_{1}", DateTime.Now.ToString("yyyyMMddhhmmss"), "result.pdf");
        ...
        static string CreateZip()
        {
            ...
            string zip = @"D:\Work\Arxprojects\2020\BatchPublishCommand\package.zip";
            return zip;
        }
